...
//  Link: gcc -m64 -no-pie -o triangle.out triangle.o geometry.o -std=c2x -Wall -z noexecstack -lm
//========1=========2=========3=========4=========5=========6=========7=========8=========9=========0=========1=========2=========3**
...
extern double triangle();   // Declare the external function "triangle" that returns a double.
...
int main(void) {
    ...
    count = triangle();   // Replacing "count" with the value of the third side
